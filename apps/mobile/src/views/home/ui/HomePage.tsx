 ...
 * 선택)으로 되돌아갈 수 있습니다. 세션 타임아웃은 아직 없습니다
    ...
    <SafeAreaView className="flex-1 bg-pink-50">
        ...
        <View className="gap-3">
          {(Object.keys(ORDER_TYPE_LABEL) as OrderType[]).map((type) => (
            ...
            >
              ...
              >
                {pendingOrderType === type && <View className="h-2 w-2 rounded-full bg-pink-500 md:h-3.5 md:w-3.5" />}
              </View>
      ...
      <Modal isOpen={isRestartConfirmOpen} onClose={() => setIsRestartConfirmOpen(false)} title="처음으로">
        ...
        <View className="mt-5 flex-row gap-2">
          ...
          <Pressable onPress={handleConfirmRestart} className="flex-1 items-center rounded-md bg-pink-500 py-2.5 md:py-5">
